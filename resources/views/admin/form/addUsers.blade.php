...
<title>{{ $title }}</title>
@section('body_web')
    <form action="{{ route('addUsersPost') }}" method="post" class="addUsers_form">
        @if (session('success'))
        ...
        <div class="contents_addusers">
            <div class="items_contents_addusers">
                <div class="form-outline mb-4">
                    ...
                    <input value="{{ old('name') }}" type="text" id="ip_tkmk" name="name" class="form-control"
                        required />
                    @error('name')
                ...
                <div class="form-outline mb-4">
                    ...
                    <input value="{{ old('email') }}" type="email" id="ip_tkmk" name="email" class="form-control"
                        required />
                    @error('email')
                ...
                <div class="form-outline mb-4">
                    ...
                    <input value="{{ old('phone') }}" type="text" id="ip_tkmk" name="phone" class="form-control"
                        required />
                    @error('phone')
